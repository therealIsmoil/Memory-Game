...
import uz.gita.memorygame.presentation.ui.dialog.DialogGiveUp
import uz.gita.memorygame.presentation.ui.dialog.NewGameDialog
import uz.gita.memorygame.presentation.ui.dialog.PauseDialog
...
import uz.gita.memorygame.utils.scope
...
class GameScreen : Fragment(R.layout.screen_game) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) = binding.scope {
        ...
        main.post {
            heightItem = (main.height / (yCount + 3)).toInt()
            widthItem = (main.width / (xCount + 0.7)).toInt()

            temp = (main.width - widthItem * xCount) / 2f
